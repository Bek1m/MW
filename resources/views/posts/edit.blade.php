        ...
        <div class="col-md-10">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h1 class="h3 mb-0">Ndrysho Postimin</h1>
                </div>
                <div class="card-body">
                    <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="type" class="form-label">Lloji i postimit *</label>
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                    <option value="" disabled>Zgjidh llojin e postimit</option>
                            ...
                            <div class="col-md-6 event-date-field" style="{{ $post->type == 'event' ? 'display: block;' : 'display: none;' }}">
                                <label for="event_date" class="form-label">Data & Koha e ngjarjes</label>
                        ...
                        <div class="mb-3">
                            <label for="categories" class="form-label">Kategoritë</label>
                        ...
                        <div class="mb-3">
                            ...
                            @if($post->image)
                                <div class="mb-2">
                                    ...
                                    <div class="form-text">Fotografia e tanishme. Zgjidh të re për ta zëvendësuar.</div>
                                </div>
                            @endif
                        ...
                        @if(auth()->user()->is_admin)
                            <div class="mb-3 form-check">
                                ...
                                <label class="form-check-label" for="is_featured">Të duket në faqen kryesore</label>
                            </div>
                            ...
                            <div class="mb-3 form-check">
                                ...
                                <label class="form-check-label" for="is_approved">Aprovo postimin</label>
                            </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ url()->previous() }}" class="btn btn-outline-secondary">Anulo</a>
